 ...
 * creation.
 */
@Immutable public class ClassAnnotation {
    ...
    void testObjectCreation() {
        ...
        RDMClass rdmClass = new RDMClass();
        ...
        new @Mutable MutableClass();
        @Mutable Object obj = new /* @Mutable */ RDMClass();
    ...
    @Immutable class ImmutableChildClassGood2 extends ImmutableClassExplicit {}

    @Immutable class ImmutableChildClassGood3 implements ImmutableInterfaceExplict, RDMInterface {}

    @Immutable class ImmutableChildClassGood4 implements RDMInterface {}
    ...
    @Immutable class ImmutableChildClassBad1 extends MutableClass {}

    // :: error: (declaration.inconsistent.with.implements.clause)
    @Immutable class ImmutableChildClassBad2 implements MutableInterface {}

    class MutableChildClassGood1 extends RDMClass {}

    class MutableChildClassGood2 extends MutableClass {}

    class MutableChildClassGood3 implements MutableInterface, RDMInterface {}

    class MutableChildClassGood4 implements RDMInterface {}

    // :: error: (declaration.inconsistent.with.extends.clause) :: error: (super.invocation.invalid)
    class MutableChildClassBad1 extends ImmutableClassExplicit {}

    // :: error: (declaration.inconsistent.with.implements.clause)
    class MutableChildClassBad2 implements ImmutableInterfaceExplict {}
